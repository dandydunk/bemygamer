"""
Django settings for bemygamer project.
...
SECRET_KEY = '2u5d(y$svvw$njs0+-kw3#b(xoyevvf-kf%)v_1_7@x1nw2%jk'
...
MIDDLEWARE = [
    ...
    'bemygamersite.middleware.CreateAnnoSession',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'bemygamersite.context_processors.default.appSettings',
...
AUTHENTICATION_BACKENDS = [
    ...
    'bemygamersite.authbackend.AuthBackEnd',
]
